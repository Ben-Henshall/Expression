...
Pod::Spec.new do |s|
  ...
  s.source           = { :git => 'https://github.com/Ben-Henshall/Expression.git.git', :tag => 0.12.9 }
  ...
  s.dependency 'BigNumber', :git => 'https://github.com/Ben-Henshall/Swift-Big-Integer.git', :branch => 'fix-scientific-notation'
end